		...
		<>
			<div className='lpContainerTop'>
				<div className='lpTop'>
					<h1 className='lpHeading'>
						The people platform-<br></br>Where interests<br></br>become friendships
					</h1>
					<p className='lpHeadingParagraph'>
						...
						people who share it on Roundup. Events are happening every day—sign up to join the fun.
					</p>
				</div>
			...
			<div className='lpContainerBottom'>
				<div className='lpBottomDiv'>
					...
					<Link to={"/groups"} className='lpBottomLink'>
						See all Groups
					</Link>
				</div>
				<div className='lpBottomDiv'>
					<img className='lpBottomImg' src={landingPageFour}></img>
					<Link to={"/events"} className='lpBottomLink'>
						Find an event
					</Link>
				</div>
				<div className='lpBottomDiv'>
					<img src={landingPageThree} className='lpBottomImg'></img>
					<Link to={"/groups/new"} className={groupLinkClass}>
						Start a new group
					</Link>
				</div>
			</div>
			{!sessionUser && (
				<div className='lpButtonDiv'>
					<OpenModalButton cssClass={"lpButton"} buttonText='Join Roundup' modalComponent={<SignupFormModal />} />
				</div>
			)}
		</>
	);
